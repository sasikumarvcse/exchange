  ...
  const handleLogin = async (email: string, password: string) => {
    ...
    try {
      ...
      if (userError || !userProfile) {
        toast.error(userError?.message || 'User profile not found.');
        setLoading(false);
        return;
      }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 to-blue-700">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Sign in to your GrowwPark account</p>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-2 text-xs text-gray-500 text-center">
            <p>Admin: admin@growwpark.com / admin123</p>
            <p>User: use registered email / password</p>
          </div>
        </div>
      </div>
    </div>
